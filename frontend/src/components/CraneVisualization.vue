...
const createCraneWithFABRIK = (): { crane: any; craneGroup: THREE.Group } => {
  ...
  for (let i = 0; i < numSegments; i++) {
    ...
    const horizontalBraces = [
      // Back
      {
        pos: [0, y, columnDepth / 2],
        rot: [0, 0, 0],
        size: [columnWidth, beamThickness, beamThickness],
      },
      // Left
      {
        pos: [-columnWidth / 2, y, 0],
        rot: [0, Math.PI / 2, 0],
        size: [columnDepth, beamThickness, beamThickness],
      },
      // Right
      {
        pos: [columnWidth / 2, y, 0],
    ...
    const sideDiagonals = [
      ...
      {
        pos: [-columnWidth / 2 + beamThickness / 2, y, 0],
        rotY: Math.PI / 2,
        rotZ: -diagonalAngle,
      },
  ...
  const armBlock1 = new THREE.Mesh(new THREE.BoxGeometry(20, 20, 100), armMaterial)
  ...
  const elbowJointVisual = new THREE.Mesh(new THREE.CylinderGeometry(8, 8, 5, 32), jointMaterial)
  ...
  const armBlock2 = new THREE.Mesh(new THREE.BoxGeometry(20, 20, 80), armMaterial)
  ...
  const wristJointVisual = new THREE.Mesh(new THREE.CylinderGeometry(8, 8, 5, 32), jointMaterial)
  ...
  const armBlock3 = new THREE.Mesh(new THREE.BoxGeometry(20, 60, 20), armMaterial)
  ...
  const gripperBase = new THREE.Mesh(new THREE.BoxGeometry(25, 10, 25), gripperMaterial)
